...
@section('sub_folder', __('main.services'))
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <div class="d-flex justify-between">
                        <div>
                            <h5 class="mb-0">@lang('main.services')</h5>
                        </div>
                        <div class="my-auto mt-lg-0 mt-4">
                            {{-- @can('add service')
                                <a href="{{ route('admin.services.create') }}" class="btn btn-primary btn-sm mb-0">+&nbsp;
                        ...
                        <table class="table table-flush" id="products-list">
                            ...
                            <tbody>
                                @foreach ($services as $key => $service)
                                    <tr>
                                        <td class=" text-sm" style="width: 80px">{{ $services->firstItem() + $key }}</td>
                                        <td>
                                        ...
                                        <td class="text-sm">
                                            <div class=""
                                                ...
                                                @can('edit service')
                                                    <a href="{{ route('admin.services.edit', $service->id) }}" class="mx-3"
