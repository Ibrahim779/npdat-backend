<!-- Start Icon Box -->
<section
class="lqd-section icon-box-page bg-gray-100 pt-90 pb-100"
      ...
      <div class="col col-12 col-md-6 col-xl-3 p-0">
        <div class="flex flex-auto p-15 transition-all">
          ...
          >
            ...
            >
            {{$aboutSetting->getIcon1Title()}}
            </h3>
            <div class="contents">
              <p>
                {{$aboutSetting->getIcon1Description()}}
              </p>
              {{-- <a
                href="./page-company-services.html"
        ...
        <div class="flex flex-auto p-15 transition-all">
          ...
          >
            ...
            <h3
              class="lqd-iconbox-heading text-center text-16 leading-1em mb-0"
            >
              {{$aboutSetting->getIcon2Title()}}
            </h3>
            <div class="contents">
              <p>
                {{$aboutSetting->getIcon2Description()}}
              </p>
              {{-- <a
                href="./page-company-services.html"
                class="btn btn-naked btn-icon-right btn-hover-swp mt-em mb-0 items-center text-15 font-bold text-secondary hover:text-primary"
        ...
        <div class="flex flex-auto p-15 transition-all">
          ...
          >
            ...
            <h3
              class="lqd-iconbox-heading text-center text-16 leading-1em mb-0"
            >
              {{$aboutSetting->getIcon3Title()}}
            </h3>
            <div class="contents">
              <p>
                {{$aboutSetting->getIcon3Description()}}
              </p>
              {{-- <a
                href="./page-company-services.html"
                class="btn btn-naked btn-icon-right btn-hover-swp mt-em mb-0 items-center text-15 font-bold text-secondary hover:text-primary"
        ...
        <div class="flex flex-auto p-15 transition-all">
          ...
          >
            ...
            <h3
              class="lqd-iconbox-heading text-center text-16 leading-1em mb-0"
            >
              {{$aboutSetting->getIcon4Title()}}
            </h3>
            <div class="contents">
              <p>
                {{$aboutSetting->getIcon4Description()}}
              </p>
              {{-- <a
                href="./page-company-services.html"
                class="btn btn-naked btn-icon-right btn-hover-swp mt-em mb-0 items-center text-15 font-bold text-secondary hover:text-primary"
